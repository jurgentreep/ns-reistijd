...
if (form) {
    form.addEventListener('submit', function (event) {
        ...
        if (input && input.files && input.files.length) {
            papaparse_1.parse(input.files[0], {
                complete: function (_a) {
                    var data = _a.data;
                    var departureString = data[1][1] + " " + data[1][0];
                    var arrivalString = data[1][3] + " " + data[1][0];
                    var departure = moment_1.default(departureString, dateFormat);
                    var arrival = moment_1.default(arrivalString, dateFormat);
